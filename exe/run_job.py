...
# Parser Arguments using the run commands #
def get_parser():
...
if __name__ == '__main__':
    ...
    if not args.interactive:
        run_cmd = f'condor_submit exe/run_image.sub commands_file={args.run_name}.txt'
    else:
        run_cmd = f'condor_submit -i exe/run_image.sub commands_file={args.run_name}.txt'
